...
ALLOWED_HOSTS = os.getenv("ALLOWED_HOSTS", 'turbolearn-backend.onrender.com', "localhost,127.0.0.1").split(",")
...
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')    # Already exists
