...
const ForgotPassword = () => {
  ...
  const handleSendOTP = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post('https://turbolearn.onrender.com/api/forgot-password/', { email });
  ...
  const handleVerifyOTP = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post('https://turbolearn.onrender.com/api/verify-otp/', {
        email,
        otp
      });
  ...
  const handleResetPassword = async (e: React.FormEvent) => {
    ...
    try {
      await axios.post('https://turbolearn.onrender.com/api/reset-password/', {
        email,
        token: resetToken,
